...
import { Upload, FileText, CheckCircle, Clock, XIcon, File } from "lucide-react";
...
const AssignmentDetails = () => {
  ...
  const handleSubmit = async() => {
    ...
    try {
      ...
      alert(error.response?.data?.message || "Failed to submit the assignment.");
    }
  };
        ...
        <CardContent className="p-8 h-full flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-6 mt-auto">
            ...
            <div className="bg-gray-50 p-5 rounded-lg border flex flex-col">
              <label className="block text-gray-700 font-medium">Upload Assignment:</label>
            ...
            {/* Comment Section */}
            <div className="bg-gray-50 p-5 rounded-lg border flex flex-col">
              <label className="block text-gray-700 font-medium">Leave a Comment:</label>
              <Textarea
