...
const ExamSecurityLayout = () => {
  ...
  return (
    <div className="w-full h-screen flex bg-gray-100  ">
      ...
      {!isFullscreen ? (
        <div className="absolute inset-0 flex items-center justify-center text-center bg-white bg-opacity-50">
          <div className="p-6 bg-whit/logo.pnge shadow-xl rounded-lg text-gray-900 max-w-md w-full">
